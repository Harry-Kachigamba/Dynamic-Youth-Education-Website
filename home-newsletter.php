...
<body>
    ...
    <main class="home-newsletter-main">

        <!--Hero Section-->
        <section class="home-header">
            <img src="images/headerimage.png" alt="headerImage" height="300" width="300" class="homeheaderimage" />

            <div class="home-header-text">
                <h3>Social Media Campaign Ltd.</h3>
                <p>We are here to provide help to teenagers to encourage them to stay online.</p>
            </div>
        </section>

        <section id="newletterWrapper">
            <h3>Newsletter</h3>
        <section id="newsletterDisplaying"></section>
        </section>
        ...
        <section class="socialmedia-home-cards">
            ...
            <div class="media-card">
                <image src="images/instagramlogo.png" width=200 class="medialogo" />
            ...
            <div class="media-card">
                <image src="images/whatsapplogo.png" width=200 class="medialogo" />
                <p>Whatsapp, a very widely used Socail Media app used for messaging in many forms; text messaging, voice messaging, sharing images, videos, documents, and on top of that video calling.</p>
                <a href="https://web.whatsapp.com/" class="link-button">Whatsapp<i class="fas fa-chevron-right"></i></a>
            </div>

            <div class="media-card">
                <image src="images/facebooklogo.png" width=200 class="medialogo" />
            ...
            <div class="media-card">
                <image src="images/twitterlogo.png" width=200 class="medialogo" />
            ...
            <div class="media-card">
                <image src="images/telegramlogo.png" width=200 class="medialogo" />
            ...
            <div class="media-card">
                <image src="images/tiktoklogo.png" width=200 class="medialogo" />
        ...
        <section class="home-info-how">
            ...
            <div class="home-info-cards">
                ...
                <div class="info-one">
                    <image src="images/secureinfo.png" alt="secure" width=200 />
                ...
                <div class="info-one">
                    <image src="images/sharing.png" alt="sharing" width=200 />
